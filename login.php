            ...
            <div class="col-lg-4 col-md-5">
                <div class="form-container">
                    <div class="media-container-column">
                        ...
                        <!---Formbuilder Form--->
                        <form action="../Control/controleLogin.php" method="GET">
                            <div class="row">
                                
                                <div class="col-md-12 form-group ">
                                    <input type="email" name="email" placeholder="Informe seu email" class="form-control">
                                </div>
                                ...
                                <div class="col-md-12 input-group-btn">
                                    <input type="submit" class="btn btn-form btn-secondary display-4" id="btn" name="logar" value="Entrar">
                                </div>
